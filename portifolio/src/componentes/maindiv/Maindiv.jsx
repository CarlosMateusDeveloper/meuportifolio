...
export default function Maindiv() {
  ...
  <section className="home  d-flex flex-row align-items-center justify-content-center container-fluid pe-5" id="home">       
        <div className="home-content reveal d-fex flex-column justify-content-center align-items-center mb-5 pe-md-5">
         ...
         <p className='text-secondary fs-5 text-end ms-0 ms-md-auto  w-75 '>Desenvolvimento de soluções de software com foco em performance, escalabilidade e design intuitivo. Especialista em React, Node.js e python  para criar aplicações web que impulsionam resultados.</p>
